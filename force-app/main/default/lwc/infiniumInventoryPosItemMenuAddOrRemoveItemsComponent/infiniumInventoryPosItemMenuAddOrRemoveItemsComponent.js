...
// To get the item list from the apex method "InfiniumInventoryPosItemToCart_Apex"
import getItems from '@salesforce/apex/InfiniumInventoryPosItemToCart_Apex.getInventoryPosItemList'
// To get the add pos item to cart from the apex method "InfiniumInventoryPosItemToCart_Apex"
import addItemToCart from '@salesforce/apex/InfiniumInventoryPosItemToCart_Apex.addInventoryPosItemToCart'
// To get the remove pos item to cart from the apex method "InfiniumInventoryPosItemToCart_Apex"
import removeItemFromCart from '@salesforce/apex/InfiniumInventoryPosItemToCart_Apex.removeInventoryPosItemFromCart'
// To get the show Toast Event from the apex method
import {
    ShowToastEvent
} from 'lightning/platformShowToastEvent';
// To get the WDW logo resoruce URl 
import WDWNoImageAvailable from '@salesforce/resourceUrl/noimageavailable';
...
export default class InfiniumInventoryPosItemMenuAddOrRemoveItemsComponent extends LightningElement {
   //To hold the brandId
   @api getBrandId = '';
   ...
   @track showSpinner;
   //To send the WDW image logo 
   wDWNoImageAvailable = WDWNoImageAvailable;
   ...
   get posItemsData() {
       ...
       if (this.getPosItems.data) {
           console.log('line 105--->',JSON.stringify(this.getPosItems.data));
