...
// to get the brandlist from the Apex class - WilsonPosItemToCart_Apex
import getActiveBrands from '@salesforce/apex/WilsonPosItemToCart_Apex.getBrandList';
// to get the getActiveItemTypes from the Apex class - WilsonPosItemToCart_Apex
import getActiveItemTypes from '@salesforce/apex/WilsonPosItemToCart_Apex.getItemTypeList';
//To check if the use has a shopping cart else create a shopping cart when user clicks place order the Apex class - WilsonPosItemToCart_Apex
import createShoppingCart from '@salesforce/apex/WilsonPosItemToCart_Apex.createInventoryShoppingCart';

export default class WilsonPosItemMenuWithFiltersComponent extends LightningElement {
