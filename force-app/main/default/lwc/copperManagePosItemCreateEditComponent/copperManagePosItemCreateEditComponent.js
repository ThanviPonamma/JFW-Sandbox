...
// importing the method addOrEditPOSItem_Apex from the class CopperManagePosItems_Apex
import addOrEditPOSItem from '@salesforce/apex/CopperManagePosItems_Apex.addOrEditPOSItem_Apex'
// importing the method getStateList from the class CopperManagePosItems_Apex
import getStateList from '@salesforce/apex/CopperManagePosItems_Apex.getAllState'
// importing the method getAllAndSelectedStates from the class CopperManagePosItems_Apex
import getAllAndSelectedStates from '@salesforce/apex/CopperManagePosItems_Apex.getAllAndSelectedStates'
//to display Toast Message
import {ShowToastEvent} from 'lightning/platformShowToastEvent';
// to refresh the apex page whenever any changes hapeens in the componenet
import {refreshApex} from '@salesforce/apex';

export default class CopperManagePosItemCreateEditComponent extends LightningElement {
    ...
    validatePosItemStockNumber() {
        ...
        if (posItemStockNumber.length > 20) {
            posItemStockNumberInputField.setCustomValidity("Please enter item number less than 20 characters.");
        }
    ...
    savePosItem() {
        console.log(JSON.stringify(this.posItems.posItemList));
        addOrEditPOSItem({
