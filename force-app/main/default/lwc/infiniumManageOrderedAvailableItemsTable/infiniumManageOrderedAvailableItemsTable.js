...
// Import the available item data from 'InfiniumWaveOrders_Apex' apex class using the method 'loadWithheldItems' and store it in 'loadAvailableItems'
import loadAvailableItems from '@salesforce/apex/InfiniumWaveOrders_Apex.loadAvailableItems'

// Import the add items to the withheld items from 'InfiniumWaveOrdersAddOrRemovePos_Apex' and store it in 'addItemToWithheldItems'
import addItemToWithheldItems from '@salesforce/apex/InfiniumWaveOrdersAddOrRemovePos_Apex.addItemToWithheldItems'

// Import method to refresh the apex class
import { refreshApex } from '@salesforce/apex';


export default class InfiniumManageOrderedAvailableItemsTable extends LightningElement {
    ...
    addItemToWithheldEvent(event) {
        ...
        // Each item has the seperate id and the varilable 'availableItemsId' is used to store the item id.
            ...
            .then(result => {
                 ...
                 refreshApex(this.getAvailableItemList);
