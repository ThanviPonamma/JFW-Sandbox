...
import getItemTypes from '@salesforce/apex/InfiniumManageItemTypes_Apex.getItemTypeList_Apex'
import deactivateSelectedItemType from '@salesforce/apex/InfiniumManageItemTypes_Apex.deactivateItemType_Apex'
// Import method refresh the page
import { refreshApex } from '@salesforce/apex';
//to display Toast Message
import { ShowToastEvent } from 'lightning/platformShowToastEvent';

export default class InfiniumManageItemTypeListComponent extends LightningElement {
    ...
    // to open popup modal
    @track isModelOpen;
    // to open the popup modal for create when this is checked
    @track isSaveAndNew;
    ...
    get itemTypeList(){
        // console.log('all item types---->',this.itemTypeListToBeDisplayed.data);
            ...
            .then(result => {
                ...
                if(resultGiven == 'done'){
                    const evt = new ShowToastEvent({
                        ...
                        message: 'The item type "'+deactivateItemType.Item_Type__c +'" has been deactivated successfully.',
                        variant: 'success',
                      });
