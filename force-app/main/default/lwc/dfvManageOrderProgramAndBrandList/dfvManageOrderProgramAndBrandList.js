...
// Author - VP,VM,TP,JP,SN,VB,

// Import the program data from 'DFVWaveOrders_Apex' apex class using the method 'loadProgramList' and store it in 'getProgramList'
import getProgramList from '@salesforce/apex/DFVWaveOrders_Apex.loadProgramList'
...
export default class DfvManageOrderProgramAndBrandList extends LightningElement {
