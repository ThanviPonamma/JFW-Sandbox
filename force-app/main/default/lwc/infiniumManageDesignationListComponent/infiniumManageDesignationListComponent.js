 ...
 * To call the child component to create/edit the designation */
 ...
 //to get the list of designation from the apex class InfiniumManageDesignationList_Apex
 import getDesignationList from '@salesforce/apex/InfiniumManageDesignationList_Apex.getDesignationList_Apex'
 //to get the deactivate the designation from the apex class InfiniumManageDesignationList_Apex
 import deactivateDesignation from '@salesforce/apex/InfiniumManageDesignationList_Apex.deactivateDesignation_Apex'
 import {ShowToastEvent} from 'lightning/platformShowToastEvent';
 import {refreshApex} from '@salesforce/apex';
 
 export default class InfiniumManageDesignationListComponent extends LightningElement {
