...
//To get the list of programs from the apex class 'InfiniumSendWaveOrders_Apex' using the method 'loadProgramList'
import getProgramList from "@salesforce/apex/InfiniumSendWaveOrders_Apex.loadProgramList"

//To get the list of users from the apex class 'InfiniumSendWaveOrders_Apex' using the method 'loadUserList'
import getUserList from "@salesforce/apex/InfiniumSendWaveOrders_Apex.loadUserList"
//to refresh the page
import { refreshApex } from'@salesforce/apex';



export default class InfiniumSendWaveOrdersProgramAndUserList extends LightningElement {
