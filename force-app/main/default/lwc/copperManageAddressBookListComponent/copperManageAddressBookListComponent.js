...
//To get the address list from the apex class "CopperManageAddressBook_Apex" with the method "LoadAddressBookListWithSearch"
import getAddressList from '@salesforce/apex/CopperManageAddressBook_Apex.loadAddressBookListWithSearch'

// To get the deactive method from the apex class "CopperManageAddressBook_Apex" to deactivate the address
import deactivateAddressBook from '@salesforce/apex/CopperManageAddressBook_Apex.deactivateAddressBook'

// To get the state list from the apex class "CopperManageAddressBook_Apex" along with the method "getAllStates"
import getStates from '@salesforce/apex/CopperManageAddressBook_Apex.getAllStates'

import synchronizeAddressBook from '@salesforce/apex/CopperManageAddressBook_Apex.synchronizeAddressBook'

import getProfile from '@salesforce/apex/CopperManageAddressBook_Apex.getProfile'
// Import method refresh the page
import {refreshApex} from '@salesforce/apex';
//to display toast message
import { ShowToastEvent} from 'lightning/platformShowToastEvent';

export default class CopperManageAddressBookListComponent extends LightningElement {
 ...
 getProfileDetails({data,error}){
     if(data) {
         ...
         if(profiledetails =="Copper Cane Admin RPT"){
