...
// Aim : To hold the functionalities of breadcrubms , cart button and to receive the custom event from  child components wilsonPosItemMenuWithFiltersComponent and wilsonPosItemMenuAddOrRemoveItemsComponent
import {LightningElement,api,track} from 'lwc';
// to import the pubsub component to navigate to shopping cart page on click view cart button
import pubsub from 'c/pubsub';

export default class WilsonPosItemMenuComponent extends LightningElement {
     //To hold the brandId
     @api brandId = '';
 ...
 // to get the brandid from the custom event detail
       ...
       this.template.querySelector('c-wilson-pos-item-menu-add-or-remove-items-component').doInit();
     }
