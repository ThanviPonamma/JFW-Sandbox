...
//importing the method addOrUpdateDesignation_Apex method from the class InfiniumManageDesignationList_Apex to add and update designation
import addOrUpdateDesignation from '@salesforce/apex/InfiniumManageDesignationList_Apex.addOrUpdateDesignation_Apex'
//import the toast message event
import { ShowToastEvent } from 'lightning/platformShowToastEvent';

export default class InfiniumManageDesignationCreateEditComponent extends LightningElement {
    ...
    saveDesignation(event) {
        //invoking a method addOrUpdateDesignation of the class InfiniumManageDesignationList_Apex
