...
// to import the pos item list from the apex class "CopperManagePosItems_Apex" with the method "getPOSItemList"
import searchPOSItem from '@salesforce/apex/CopperManagePosItems_Apex.searchPOSItem_Apex'
// to import the list of brand from the apex class "CopperManagePosItems_Apex" with the method "getBrandList_Apex"
import getBrandList from '@salesforce/apex/CopperManagePosItems_Apex.getBrandList_Apex'
// to import the list of item type from the apex class "CopperManagePosItems_Apex" with the method "getItemTypeList_Apex"
import getItemTypeList from '@salesforce/apex/CopperManagePosItems_Apex.getItemTypeList_Apex'
import deactivateSelectedItem from '@salesforce/apex/CopperManagePosItems_Apex.deactivateSelectedItem'
// to display no image
...
export default class CopperManagePosItemListComponent extends LightningElement {
