...
import getAllCometOrders from '@salesforce/apex/CopperPreviewOrder_Apex.getAllCometOrders'
...
export default class CopperPreviewOrderDetailsComponent extends LightningElement {
...
//To hold the fetched preview orders from the backend
    get cometOrders() {
        // console.log('buybookid in child----->',this.buyBookId);
