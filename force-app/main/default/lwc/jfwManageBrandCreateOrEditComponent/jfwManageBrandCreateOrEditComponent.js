...
//importing the method addBrand method from the class JFWManageBrandList_Apex to update a brand
...
saveBrand(event){
  ...
  //invoking a method updateBrandOnEdit of the class JFWManageBrandList_Apex
  updateBrandOnEdit({  
