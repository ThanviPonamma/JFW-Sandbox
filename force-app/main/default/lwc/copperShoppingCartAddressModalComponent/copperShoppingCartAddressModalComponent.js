...
//Aim: to display the list of addresses and shipping menthods along with search filter and pagination in    the popup modal
    ...
    import saveAddressForAllOrderedItems from '@salesforce/apex/CopperShoppingCartItem_Apex.saveAddressForAllOrderedItems'
    // to get the address book list on click on Add same address
    import getUserAddressBookList from '@salesforce/apex/CopperShoppingCartItem_Apex.getUserAddressBookList'
   
    import {
        refreshApex
    } from '@salesforce/apex';
    
export default class CopperShoppingCartAddressModalComponent extends LightningElement {
    ...
    //to hold buybook id
         ...
         var selectedUserListBeforeApexCall =  this.selectedAddressList;
          //checks if the pop-up is for add same address ,the assigns then results to the variables
              ...
              if (this.resultOfAllAddress.data) {
               // console.log('resultOfAllAddress');
      ...
      saveSelectedAddress() {
              ...
              saveAddressForAllOrderedItems({
                      ...
                      selectedBuyBookId:this.buyBookId//changed posItemIdForShippingAddress
                  })
                  .then(result => {
                      let savedAddresses = result;
                     //console.log('save address result--->',savedAddresses);
                      this.isModalOpen = false;
                      const closeButton = new CustomEvent('closemodal', {
                          detail: this.isModalOpen
                      })
