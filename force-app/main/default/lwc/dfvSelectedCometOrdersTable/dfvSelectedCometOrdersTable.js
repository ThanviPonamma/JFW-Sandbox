...
// import variable to store the selected comet order list sent from the 'DFVSendWaveOrders_Apex' class.
import selectedCometOrderList from '@salesforce/apex/DFVSendWaveOrders_Apex.loadSelectedCometOrders'

// Import method  to remove the data  from the apex class using the method "removeAvailableOrder" 
import removeAvailableOrder from '@salesforce/apex/DFVSendWaveAddOrRemoveOrders.removeAvailableOrder'

// Import method  to submit the data to warehouse from the apex class using the method "submitSelectedOrdersToComet"
import submitSelectedOrdersToComet from '@salesforce/apex/DFVSubmitWaveOrder_Apex.submitSelectedOrdersToComet'
...
export default class DfvSelectedCometOrdersTable extends LightningElement {
