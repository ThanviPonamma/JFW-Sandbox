// <!-- Authors:Sanjana,JayaPrasad
// Date:20-10-2020
// Aim: This is the child component that is responsible for displaying brand table -->

import { LightningElement,wire,track,api } from 'lwc';
import getAllBrandList from '@salesforce/apex/JFWManageBrandList_Apex.getBrandList'
import deactivateSelectedBrand from '@salesforce/apex/JFWManageBrandList_Apex.deactivateBrandApex'
import { ShowToastEvent } from 'lightning/platformShowToastEvent';
import { refreshApex } from '@salesforce/apex';

export default class JfwManageBrandList extends LightningElement {
...
//to get the list of brands on page initconsole
get getAllBrands(){
...
if(this.brandList.data){
    ...
    //console.log('allBrandList---->',JSON.stringify(this.allBrandList));
    // holds only the list of brand details
...
openEditPopUp(event){
    ...
    // console.log('selectedBrandDetails---->',JSON.stringify(this.selectedBrandDetails));
    // to hold the name of the brand as label 
...
addOrRemoveUserToBrand(event){
    ...
    // to hold the name of the brand as label 
    this.labelName = brandDetails.Brand_Name__c;
    // console.log('label name in parent--->',this.labelName);
    // to hold the name of the selected brand
