// <!-- Authors:SN,JP Date:20-10-2020 -->
// <!-- Aim: To add/remove the user for a brand as a brand user -->

import { LightningElement,wire, api, track } from 'lwc';
// importing the method getCurrentBrandMangerList from the class JFWManageBrandList_Apex
import getCurrentBrandUserList from '@salesforce/apex/JFWManageBrandList_Apex.getCurrentBrandMangerList';
//importing the method addUserToBrandManager from the class JFWManageBrandList_Apex
import addUserToBrand from '@salesforce/apex/JFWManageBrandList_Apex.addUserToBrandManager';
...
export default class JfwManageTerritoriesUsers extends LightningElement {
   ...
   // This is the LWC Lifecycle method and it is invoked on page load
    ...
    @wire(getCurrentBrandUserList,{brandId:'$selectedBrandId'})
    getUserList;
