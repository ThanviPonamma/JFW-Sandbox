...
import getAllPositems from '@salesforce/apex/WilsonHandleASNPOSItemsList_Apex.loadPosItemList'
import saveAdvanceShipmentNotice from '@salesforce/apex/WilsonHandleASNPOSItemsList_Apex.saveAdvanceShipmentNotice'
import {
    refreshApex
...
export default class WilsonManageAdvanceShipmentNoticeCreateEditComponent extends LightningElement {
    ...
    validateASNData() {
        ...
        // console.log('this.selectedPosItems.length',this.selectedPosItems.length)
