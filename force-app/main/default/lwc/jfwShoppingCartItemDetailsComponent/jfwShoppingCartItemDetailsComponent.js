...
// to ge the cart item list from the apex method 'getCartItemsList' of class 'JFWInventoryShoppingCart_Apex'
import getCartItemsList from '@salesforce/apex/JFWInventoryShoppingCart_Apex.getCartItemsList'
// to ge the updated quantity for the selected pos items from the apex method 'updateQuantityForSelectedItem' of class 'JFWInventoryShoppingCart_Apex'
import updateQuantityForSelectedPosItem from '@salesforce/apex/JFWInventoryShoppingCart_Apex.updateQuantityForSelectedItem'
// to send the pos items to the apex method 'deleteCartItemFromShippingCart' of the class 'JFWInventoryShoppingCart_Apex' if user wants to delete the items
import deleteCartItemFromShippingCart from '@salesforce/apex/JFWInventoryShoppingCart_Apex.deleteCartItemFromShippingCart'
//  to get the shipping method to the dropdown
import getShippingMethodList from '@salesforce/apex/JFWInventoryShoppingCart_Apex.getShippingMethodList'
...
import getSelectedUserAddressBookListForAllItems from '@salesforce/apex/JFWInventoryShoppingCart_Apex.getSelectedUserAddressBookListForAllItems'
// to send the selected pos items to apex method
import getSelectedAddressesForPosItem from '@salesforce/apex/JFWInventoryShoppingCart_Apex.getSelectedAddressesForPosItem'
// To check if the address is domastic or international
import getUserDetails from '@salesforce/apex/JFWInventoryShoppingCart_Apex.getUserDetails'

export default class JfwShoppingCartItemDetailsComponent extends LightningElement {
