...
// to get the brandlist from the Apex class - InfiniumInventoryPosItemToCart_Apex
import getActiveBrands from '@salesforce/apex/InfiniumInventoryPosItemToCart_Apex.getBrandList';
// to get the getActiveItemTypes from the Apex class - InfiniumInventoryPosItemToCart_Apex
import getActiveItemTypes from '@salesforce/apex/InfiniumInventoryPosItemToCart_Apex.getItemTypeList';
//To check if the use has a shopping cart else create a shopping cart when user clicks place order the Apex class - InfiniumInventoryPosItemToCart_Apex
import createShoppingCart from '@salesforce/apex/InfiniumInventoryPosItemToCart_Apex.createInventoryShoppingCart';

export default class InfiniumInventoryPosItemMenuWithFiltersComponent extends LightningElement {
