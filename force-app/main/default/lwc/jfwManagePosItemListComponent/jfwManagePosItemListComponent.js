...
// to import the pos item list from the apex class "JFWManagePosItems_Apex" with the method "getPOSItemList"
import searchPOSItem from '@salesforce/apex/JFWManagePosItems_Apex.searchPOSItem'
// to import the list of brand from the apex class "JFWManagePosItems_Apex" with the method "getBrandList"
import getBrandList from '@salesforce/apex/JFWManagePosItems_Apex.getBrandList'
// to import the list of item type from the apex class "JFWManagePosItems_Apex" with the method "getItemTypeList"
import getItemTypeList from '@salesforce/apex/JFWManagePosItems_Apex.getItemTypeList'
import deactivateSelectedItem from '@salesforce/apex/JFWManagePosItems_Apex.deactivateSelectedItem'
// to display no image
...
export default class JfwManagePosItemListComponent extends LightningElement {
