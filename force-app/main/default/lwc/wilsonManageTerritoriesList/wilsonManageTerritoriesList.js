...
// To  get the terrotory list from the Apex class WilsonMangeTerritories_Apex using the method getTerritoryList
import getTerritoryList from '@salesforce/apex/WilsonMangeTerritories_Apex.getTerritoryList'
// To deactivate a territory using the Apex class WilsonMangeTerritories_Apex using the method deactivateTerritoryApex
import deactivateTerritoryApex from '@salesforce/apex/WilsonMangeTerritories_Apex.deactivateTerritoryApex'
//to display toast message
import { ShowToastEvent } from 'lightning/platformShowToastEvent';
// Import method refresh the page
import { refreshApex } from '@salesforce/apex';
export default class WilsonManageTerritoriesList extends LightningElement {
