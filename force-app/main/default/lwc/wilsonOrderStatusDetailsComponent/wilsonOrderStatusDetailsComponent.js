...
// to get all the ordered details from the apex method 'getAllInventoryOrders' of the apex class "WilsonInventoryOrderStatus_Apex"
import getAllInventoryOrders from '@salesforce/apex/WilsonInventoryOrderStatus_Apex.getAllInventoryOrders'
// To get the selected ordered details to view the data from the apex method "getOrderDetailsOfSelectedOrder"
import getOrderDetailsOfSelectedOrder from '@salesforce/apex/WilsonInventoryOrderStatus_Apex.getOrderDetailsOfSelectedOrder'
...
export default class WilsonOrderStatusDetailsComponent extends NavigationMixin(LightningElement) {
...
// boolean variable if the order status is shipped
 ...
 //To hold all the ordered details from the apex method 'getAllInventoryOrders' of the apex class "wilsonInventoryOrderStatus_Apex"
