...
//importing a method getSubmittedASNPosItemsList from the class CopperGetSubmittedASNList_Apex
import getAllASNDetails from '@salesforce/apex/CopperGetSubmittedASNList_Apex.getSubmittedASNPosItemsList'

export default class CopperManageAdvanceShipmentNoticeViewDetailsComponent extends LightningElement {
    //to hold asn details
    @api getAsnDetails;
