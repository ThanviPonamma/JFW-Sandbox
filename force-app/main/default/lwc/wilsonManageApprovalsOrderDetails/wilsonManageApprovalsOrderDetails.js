...
import approveShippingMethod_Apex from '@salesforce/apex/WilsonManageApproval_Apex.approveShippingMethod';
//To save the rejected shippping method
import rejectShippingMethod_Apex from '@salesforce/apex/WilsonManageApproval_Apex.rejectShippingMethod';
//To save the approved items
import approveOrderedItem_Apex from '@salesforce/apex/WilsonManageApproval_Apex.approveOrderedItem';
//To save the rejected items
import rejectOrderedItem_Apex from '@salesforce/apex/WilsonManageApproval_Apex.rejectOrderedItem';
//To save the approved max ordered item
import approveMaximumOrderQuantity_Apex from '@salesforce/apex/WilsonManageApproval_Apex.approveMaximumOrderQuantity';
//To save the rejected max ordered item
import rejectMaximumOrderQuantity_Apex from '@salesforce/apex/WilsonManageApproval_Apex.rejectMaximumOrderQuantity';


export default class WilsonManageApprovalsOrderDetails extends LightningElement {
