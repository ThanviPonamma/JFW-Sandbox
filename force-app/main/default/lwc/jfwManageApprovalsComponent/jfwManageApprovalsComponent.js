...
import loadAllCometApprovalOrders from '@salesforce/apex/JFWManageApproval_Apex.loadAllCometApprovalOrders';
//To get all the shipping method List
import loadShippingMethodList from '@salesforce/apex/JFWManageApproval_Apex.loadShippingMethodList';
// Import method refresh the page
import { refreshApex } from '@salesforce/apex';
 // To add publish and subscribe model
import pubsub from 'c/pubsub' ;

export default class JfwManageApprovalsComponent extends LightningElement {
  ...
  get cometOrderApprovalList(){
    ...
    invokeChildRefresh(){
      if(this.isCometOrders && this.isShippingMethod){
        ...
        this.template.querySelector('c-jfw-manage-approvals-order-details').doInit();
      }
    }
