...
import availableCometOrderList from '@salesforce/apex/InfiniumSendWaveOrders_Apex.loadAvailableCometOrders'
// To get the Pos Items for the Comet Order from the apex class using the method "loadPosItemsForCometOrder"
import loadPosItemsForCometOrder from '@salesforce/apex/InfiniumSendWaveOrders_Apex.loadPosItemsForCometOrder'
// add Orders to Selected Comet Orders list from the apex class using the method "addAvailableOrder"
import addOrdersToSelectedCometOrders from '@salesforce/apex/InfiniumSendWaveAddOrRemoveOrders.addAvailableOrder'
import { refreshApex } from '@salesforce/apex';

export default class InfiniumAvailableCometOrdersTable extends LightningElement {
