...
// to get all the ordered details from the apex method 'getAllInventoryOrders' of the apex class "InfiniumInventoryOrderStatus_Apex"
import getAllInventoryOrders from '@salesforce/apex/InfiniumInventoryOrderStatus_Apex.getAllInventoryOrders'
// To get the selected ordered details to view the data from the apex method "getOrderDetailsOfSelectedOrder"
import getOrderDetailsOfSelectedOrder from '@salesforce/apex/InfiniumInventoryOrderStatus_Apex.getOrderDetailsOfSelectedOrder'
...
export default class InfiniumInventoryOrderStatusDetailsComponent extends NavigationMixin(LightningElement) {
...
// boolean variable if the order status is shipped
 ...
 //To hold all the ordered details from the apex method 'getAllInventoryOrders' of the apex class "InfiniumInventoryOrderStatus_Apex"
