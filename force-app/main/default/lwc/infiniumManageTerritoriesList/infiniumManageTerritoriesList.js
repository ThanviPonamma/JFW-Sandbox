...
// To  get the terrotory list from the Apex class InfiniumMangeTerritories_Apex using the method getTerritoryList
import getTerritoryList from '@salesforce/apex/InfiniumManageTerritories_Apex.getTerritoryList'
// To deactivate a territory using the Apex class InfiniumMangeTerritories_Apex using the method deactivateTerritoryApex
import deactivateTerritoryApex from '@salesforce/apex/InfiniumManageTerritories_Apex.deactivateTerritoryApex'
//to display toast message
import { ShowToastEvent } from 'lightning/platformShowToastEvent';
// Import method refresh the page
import { refreshApex } from '@salesforce/apex';
export default class InfiniumManageTerritoriesList extends LightningElement {
