...
// to get the brandlist from the Apex class - InfiniumPosItemToCart_Apex
import getActiveBrands from '@salesforce/apex/InfiniumPosItemToCart_Apex.getBrands_Apex';
// to get the getActiveItemTypes from the Apex class - InfiniumPosItemToCart_Apex
import getActiveItemTypes from '@salesforce/apex/InfiniumPosItemToCart_Apex.getItemTypes_Apex';
//To check if the use has a shopping cart else create a shopping cart when user clicks place order the Apex class - InfiniumPosItemToCart_Apex
import createShoppingCart from '@salesforce/apex/InfiniumPosItemToCart_Apex.createSeasonalShoppingCart_Apex';
// To get the remove pos item to cart from the apex method "InfiniumPosItemToCart_Apex"
import addAllPosItemsToCart from '@salesforce/apex/InfiniumPosItemToCart_Apex.addAllPosItemsToCart_Apex'

export default class InfiniumPosItemMenuWithFiltersComponent extends LightningElement {
    ...
    connectedCallback() {
        createShoppingCart({ selectedProgramId: this.programId })
            .then(result => {
    ...
    addAllProgramItemsToCart(event) {
