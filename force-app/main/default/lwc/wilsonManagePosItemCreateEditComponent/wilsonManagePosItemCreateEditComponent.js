...
// importing the method addOrEditPOSItem from the class WilsonManagePosItems_Apex
import addOrEditPOSItem from '@salesforce/apex/WilsonManagePosItems_Apex.addOrEditPOSItem'
// importing the method getStateList from the class WilsonManagePosItems_Apex
import getStateList from '@salesforce/apex/WilsonManagePosItems_Apex.getAllState'
// importing the method getAllAndSelectedStates from the class WilsonManagePosItems_Apex
import getAllAndSelectedStates from '@salesforce/apex/WilsonManagePosItems_Apex.getAllAndSelectedStates'
...
export default class WilsonManagePosItemCreateEditComponent extends LightningElement {
    ...
    validateHarmonizationCode() {
     ...
     // Author: Sanjana
    //Date: 24/3/2021
    //Commenting the below lines and rewriting the method to satisfy the CR - Wilson-24-Mar-03 
    // POS Item Image
    ...
    get getStateListToBeDisplayed() {
        ...
        if (this.getStates.data) {
            ...
            // console.log('assignedStateList---->',this.assignedStateList);
