...
//To get the address list from the apex class "InfiniumManageAddressBook_Apex" with the method "LoadAddressBookListWithSearch"
import getAddressList from '@salesforce/apex/InfiniumManageAddressBook_Apex.loadAddressBookListWithSearch'

// To get the deactive method from the apex class "InfiniumManageAddressBook_Apex" to deactivate the address
import deactivateAddressBook from '@salesforce/apex/InfiniumManageAddressBook_Apex.deactivateAddressBook'

// To get the state list from the apex class "InfiniumManageAddressBook_Apex" along with the method "getAllStates"
import getStates from '@salesforce/apex/InfiniumManageAddressBook_Apex.getAllStates'

import synchronizeAddressBook from '@salesforce/apex/InfiniumManageAddressBook_Apex.synchronizeAddressBook'

import getProfile from '@salesforce/apex/InfiniumManageAddressBook_Apex.getProfile'
// Import method refresh the page
import {refreshApex} from '@salesforce/apex';
//to display toast message
import { ShowToastEvent} from 'lightning/platformShowToastEvent';

export default class InfiniumManageAddressBookListComponent extends LightningElement {
    ...
    //to hold the if the button clicked is edit /create.
    @api isEditClicked;
 ...
 getProfileDetails({data,error}){
     if(data) {
         ...
         if(profiledetails =="Infinium Cane Admin RPT"){
        ...
        deactivateAddressBook({
            ...
            .then(result => {
                ...
                const evt = new ShowToastEvent({
                    ...
                    message: 'The address "' + addressBook.Destination_Name__c + '" has been deactivated successfully.',
                    variant: 'success',
                });
