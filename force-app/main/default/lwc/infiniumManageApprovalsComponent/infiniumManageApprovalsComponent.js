...
import loadAllCometApprovalOrders from '@salesforce/apex/InfiniumManageApproval_Apex.loadAllCometApprovalOrders';
//To get all the shipping method List
import loadShippingMethodList from '@salesforce/apex/InfiniumManageApproval_Apex.loadShippingMethodList';
// Import method refresh the page
import { refreshApex } from '@salesforce/apex';
 // To add publish and subscribe model
import pubsub from 'c/pubsub' ;

export default class InfiniumManageApprovalsComponent extends LightningElement {
 ...
 get cometOrderApprovalList(){
   ...
   invokeChildRefresh(){
     if(this.isCometOrders && this.isShippingMethod){
       ...
       this.template.querySelector('c-infinium-manage-approvals-order-details').doInit();
     }
   }
