...
// to import the shipping method list from the apex class "WilsonManageShippingMethods_Apex" with the method "getShippingMethodList"
import getShippingMethodList from '@salesforce/apex/WilsonManageShippingMethods_Apex.getShippingMethodList'

// import method to deactivate the shipping method
import deactivateShippingMethod from '@salesforce/apex/WilsonManageShippingMethods_Apex.deactivateShippingMethod'
...
export default class WilsonManageShippingMethodListComponent extends LightningElement {
...
get shippingMethod(){ 
    if(this.getShippingMethodListToDisplay.data){
      this.shippingMethodtotalData = this.getShippingMethodListToDisplay.data;
        ...
        // console.log('shippingMethodList--->',JSON.stringify(this.shippingMethodList));
        // console.log('shippingMethodNamesForValidation--->',JSON.stringify(this.shippingMethodNamesForValidation));
...
handleChangeDeactivateShippingeMethods(event){
    ...
    // console.log('deactivatedShippingMethod',JSON.stringify(deactivatedShippingMethod))
