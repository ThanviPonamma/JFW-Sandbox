...
// To  get the Current Territory User List from the Apex class CopperMangeTerritoryUsers_Apex using the method getCurrentTerritoryUserList
import getCurrentTerritoryUserList from '@salesforce/apex/CopperMangeTerritoryUsers_Apex.getCurrentTerritoryUserList';
// To  add the user Territory from the Apex class CopperMangeTerritoryUsers_Apex using the method addUserToTerritory
import addUserToTerritory from '@salesforce/apex/CopperMangeTerritoryUsers_Apex.addUserToTerritory';
//to display toast message
import { ShowToastEvent } from 'lightning/platformShowToastEvent';
// Import method refresh the page
import { refreshApex } from '@salesforce/apex';

export default class CopperManageTerritoriesUsers extends LightningElement {
