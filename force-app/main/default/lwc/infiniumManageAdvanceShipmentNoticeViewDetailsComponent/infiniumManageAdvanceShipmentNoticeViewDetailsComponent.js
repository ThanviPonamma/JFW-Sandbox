...
//importing a method getSubmittedASNPosItemsList from the class InfiniumGetSubmittedASNList_Apex
import getAllASNDetails from '@salesforce/apex/InfiniumGetSubmittedASNList_Apex.getSubmittedASNPosItemsList'


export default class InfiniumManageAdvanceShipmentNoticeViewDetailsComponent extends LightningElement {
    //to hold asn details
    @api getAsnDetails;
