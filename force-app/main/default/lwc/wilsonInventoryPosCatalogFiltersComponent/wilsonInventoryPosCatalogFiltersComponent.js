...
// Aim:This is the child component of wilsonInventoryPosCatalogComponent which is responsible to display the filter inputs and download button and to send brand Id and search keyword to the parent


import { LightningElement ,wire ,track} from 'lwc';
import getBrands from '@salesforce/apex/WilsonInventoryPOSCatalog_Apex.getBrandList';
//to get the account details
import getAccountDetails from '@salesforce/apex/WilsonInventoryPOSCatalog_Apex.getAccount';
...
export default class WilsonInventoryPosCatalogFiltersComponent extends NavigationMixin(LightningElement) {
  ...
  //to get the list of brands from the apex class wilsonPosItemToCart_Apex and the method getBrandList
  @wire(getBrands)
...
//event that is invoked onclick of the 'download PDF' button which is responsible to navigate to the visual force page Wilson_POS_Catalog_Logo and download pdf file
   getPOSCatalog(event){
      //  check if the variable brandValue is empty or null
       if(this.brandValue==''||this.brandValue==null){
          //  navigate to the visual force page Wilson_POS_Catalog_Logo 
          this[NavigationMixin.GenerateUrl]({
              type: 'standard__webPage',
              attributes: {
                 
                  url:  this.accountURL+'/Wilson_POS_Catalog_Logo'
              }
          ...
          this[NavigationMixin.GenerateUrl]({
              ...
              attributes: {
                  ...
                  url:  this.accountURL+'/Wilson_POS_Catalog_Logo'+'?id='+this.brandValue
              }
