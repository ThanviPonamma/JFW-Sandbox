...
import getCurrentTerritoryStateList from '@salesforce/apex/WilsonMangeTerritoryStates_Apex.getCurrentTerritoryStateList';
//To save the assigned state list to the territory
import addStateToTerritoryApex from '@salesforce/apex/WilsonMangeTerritoryStates_Apex.addStateToTerritory';
...
export default class WilsonManageTerritoriesStates extends LightningElement {
      ...
      get currentTerritoryStateList(){
          ...
          // console.log('availableStateList',JSON.stringify(this.availableStateList));
          //to hold assigned state list
          this.assignedStateList = StateOptionsListWrapper.selectedStates;
          // console.log('assignedStateList',JSON.stringify(this.assignedStateList));
          }
      }
      ...
      saveTerritoryState(event){
          // console.log('StateListTobeAssigned--->',JSON.stringify(this.StateListTobeAssigned))
