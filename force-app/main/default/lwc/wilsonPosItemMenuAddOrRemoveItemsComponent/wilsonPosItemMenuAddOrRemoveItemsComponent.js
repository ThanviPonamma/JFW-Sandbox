...
// To get the item list from the apex method "WilsonPosItemToCart_Apex"
import getItems from '@salesforce/apex/WilsonPosItemToCart_Apex.getInventoryPosItemList'
// To get the add pos item to cart from the apex method "WilsonPosItemToCart_Apex"
import addItemToCart from '@salesforce/apex/WilsonPosItemToCart_Apex.addInventoryPosItemToCart'
// To get the remove pos item to cart from the apex method "WilsonPosItemToCart_Apex"
import removeItemFromCart from '@salesforce/apex/WilsonPosItemToCart_Apex.removeInventoryPosItemFromCart'
...
export default class WilsonPosItemMenuAddOrRemoveItemsComponent extends LightningElement {
   //To hold the brandId
   @api getBrandId = '';
