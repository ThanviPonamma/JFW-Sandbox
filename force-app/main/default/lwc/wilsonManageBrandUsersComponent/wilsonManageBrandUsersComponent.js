/** Authors:Vanditha,Thanvi Date:05-01-2021 -->
 Aim: To add/remove the user for a brand as a brand user */

import {LightningElement,wire,api,track} from 'lwc';
// importing the method getCurrentBrandMangerList from the class WilsonManageBrandList_Apex
import getCurrentBrandUserList from '@salesforce/apex/WilsonManageBrandList_Apex.getCurrentBrandMangerList';
//importing the method addUserToBrandManager from the class WilsonManageBrandList_Apex
import addUserToBrand from '@salesforce/apex/WilsonManageBrandList_Apex.addUserToBrandManager';
// importing the refresh apex event
import {refreshApex} from '@salesforce/apex';
// importing the toast event
import {ShowToastEvent} from 'lightning/platformShowToastEvent';

export default class WilsonManageBrandUsersComponent extends LightningElement {
    ...
    connectedCallback() {
        ...
        // console.log('labelname in child--->',JSON.stringify(this.labelName));  
