...
//importing the method searchPOSItem from the class InfiniumInventoryPOSCatalog_Apex
import searchPosItem from '@salesforce/apex/InfiniumInventoryPOSCatalog_Apex.searchPOSItem'
// importing the noimageavailable image from the static resource
import noImage from '@salesforce/resourceUrl/noimageavailable'



export default class InfiniumInventoryPosCatalogTableComponent extends LightningElement {
...
@wire(searchPosItem,{searchText :'$getSearchValue', selectedBrandId :'$getBrandId'}) posItems;
