...
// importing the method getCurrentBrandMangerList from the class CopperManageBrandList_Apex
import getCurrentBrandUserList from '@salesforce/apex/CopperManageBrandList_Apex.getCurrentBrandMangerList';
//importing the method addUserToBrandManager from the class CopperManageBrandList_Apex
import addUserToBrand from '@salesforce/apex/CopperManageBrandList_Apex.addUserToBrandManager';
// importing the refresh apex event
import {refreshApex} from '@salesforce/apex';
// importing the toast event
import {ShowToastEvent} from 'lightning/platformShowToastEvent';

export default class CopperManageBrandUsersComponent extends LightningElement {
