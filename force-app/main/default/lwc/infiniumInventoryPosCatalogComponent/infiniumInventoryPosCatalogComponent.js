...
export default class InfiniumInventoryPosCatalogComponent extends LightningElement {

// To hold the brand Id coming from the component infiniumInventortPosCatalogComponent
@api brandId = '';
// To hold the search value coming from the component infiniumInventortPosCatalogComponent
@api searchValue = '';
