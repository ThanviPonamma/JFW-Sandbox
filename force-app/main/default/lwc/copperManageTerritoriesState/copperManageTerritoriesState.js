...
import getCurrentTerritoryStateList from '@salesforce/apex/CopperManageTerritoriesStates_Apex.getCurrentTerritoryStateList';
//To save the assigned state list to the territory
import addStateToTerritoryApex from '@salesforce/apex/CopperManageTerritoriesStates_Apex.addStateToTerritory';
//to display toast message
import { ShowToastEvent } from 'lightning/platformShowToastEvent';
// Import method refresh the page
import { refreshApex } from '@salesforce/apex';
export default class CopperManageTerritoriesState extends LightningElement {
