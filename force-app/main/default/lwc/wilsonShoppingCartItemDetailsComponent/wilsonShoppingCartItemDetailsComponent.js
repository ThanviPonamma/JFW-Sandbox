...
// to ge the cart item list from the apex method 'getCartItemsList' of class 'WilsonInventoryShoppingCart_Apex'
import getCartItemsList from '@salesforce/apex/WilsonInventoryShoppingCart_Apex.getCartItemsList'
// to ge the updated quantity for the selected pos items from the apex method 'updateQuantityForSelectedItem' of class 'WilsonInventoryShoppingCart_Apex'
import updateQuantityForSelectedPosItem from '@salesforce/apex/WilsonInventoryShoppingCart_Apex.updateQuantityForSelectedItem'
// to send the pos items to the apex method 'deleteCartItemFromShippingCart' of the class 'WilsonInventoryShoppingCart_Apex' if user wants to delete the items
import deleteCartItemFromShippingCart from '@salesforce/apex/WilsonInventoryShoppingCart_Apex.deleteCartItemFromShippingCart'
//  to get the shipping method to the dropdown
import getShippingMethodList from '@salesforce/apex/WilsonInventoryShoppingCart_Apex.getShippingMethodList'
...
import WilsonDanielNoImage from '@salesforce/resourceUrl/noimageavailable';
// to send add same address to all to apex method
import getSelectedUserAddressBookListForAllItems from '@salesforce/apex/WilsonInventoryShoppingCart_Apex.getSelectedUserAddressBookListForAllItems'
// to send the selected pos items to apex method
import getSelectedAddressesForPosItem from '@salesforce/apex/WilsonInventoryShoppingCart_Apex.getSelectedAddressesForPosItem'
// To check if the address is domastic or international
import getUserDetails from '@salesforce/apex/WilsonInventoryShoppingCart_Apex.getUserDetails'

export default class WilsonShoppingCartItemDetailsComponent extends LightningElement {
    ...
    wilsonDanielNoImage = WilsonDanielNoImage;
