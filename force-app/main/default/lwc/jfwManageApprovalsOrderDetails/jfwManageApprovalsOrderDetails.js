...
import approveShippingMethod_Apex from '@salesforce/apex/JFWManageApproval_Apex.approveShippingMethod';
//To save the rejected shippping method
import rejectShippingMethod_Apex from '@salesforce/apex/JFWManageApproval_Apex.rejectShippingMethod';
//To save the approved items
import approveOrderedItem_Apex from '@salesforce/apex/JFWManageApproval_Apex.approveOrderedItem';
//To save the rejected items
import rejectOrderedItem_Apex from '@salesforce/apex/JFWManageApproval_Apex.rejectOrderedItem';
//To save the approved max ordered item
import approveMaximumOrderQuantity_Apex from '@salesforce/apex/JFWManageApproval_Apex.approveMaximumOrderQuantity';
//To save the rejected max ordered item
import rejectMaximumOrderQuantity_Apex from '@salesforce/apex/JFWManageApproval_Apex.rejectMaximumOrderQuantity';

export default class JfwManageApprovalsOrderDetails extends LightningElement {
...
// To get the selected shipping method id
    ...
    approveItem(event) {
        ...
        // console.log('The approve items--->',JSON.stringify(updatedCometOrderItem))
    ...
    rejectItem(event) {
        let updatedCometOrderItem = event.target.value;
        // console.log('The reject items--->',JSON.stringify(updatedCometOrderItem))
