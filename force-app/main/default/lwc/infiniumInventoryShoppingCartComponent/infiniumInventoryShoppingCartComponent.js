...
export default class InfiniumInventoryShoppingCartComponent extends LightningElement {
  ...
  openPreviewComponent(event) {
      ...
      pubsub.fire('inventoryprevieworderevent', 'inventoryprevieworder');
      //to hold the orderId
      pubsub.fire('inventoryprevieworderId', this.orderId);
  }
