...
// To  get the terrotory list from the Apex class JFWMangeTerritories_Apex using the method getTerritoryList
import getTerritoryList from '@salesforce/apex/JFWMangeTerritories_Apex.getTerritoryList'
// To deactivate a territory using the Apex class JFWMangeTerritories_Apex using the method deactivateTerritoryApex
import deactivateTerritoryApex from '@salesforce/apex/JFWMangeTerritories_Apex.deactivateTerritoryApex'
//to display toast message
import { ShowToastEvent } from 'lightning/platformShowToastEvent';
// Import method refresh the page
import { refreshApex } from '@salesforce/apex';

export default class JfwManageTerritoriesList extends LightningElement {
...
@track territoryListFound=false;
    ...
    get territoriesToBeDisplayed(){
        if(this.getTerritoryList.data){
            ...
            // console.log('territoryList--->',JSON.stringify(this.territoryList));
            //to hold territory names for validation
            this.territoryNamesForValidation = territories.territoryNamesForValidation;
            // console.log('territoryNamesForValidation--->',JSON.stringify(this.territoryNamesForValidation));
