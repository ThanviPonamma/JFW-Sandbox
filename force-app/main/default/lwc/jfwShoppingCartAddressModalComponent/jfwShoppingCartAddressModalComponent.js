...
import saveAddressForSelectedItem from '@salesforce/apex/JFWInventoryShoppingCart_Apex.saveAddressForSelectedItem'
//to save addresses for all items
import saveAddressForAllOrderedItems from '@salesforce/apex/JFWInventoryShoppingCart_Apex.saveAddressForAllOrderedItems'
// to get the address book list on click on Add same address
import getUserAddressBookList from '@salesforce/apex/JFWInventoryShoppingCart_Apex.getUserAddressBookList'
//to get the address book list on click on shipping address
import getPosItemUserAddressBookList from '@salesforce/apex/JFWInventoryShoppingCart_Apex.getPosItemUserAddressBookList'
import {
    refreshApex
} from '@salesforce/apex';

export default class JfwShoppingCartAddressModalComponent extends LightningElement {
...
// to selected adddress to get fom the parent
    ...
    setNavigationItems(startnumber, lastnumber) {
        ...
        // console.log('totalAddressListSize-->',this.totalAddressListSize)
