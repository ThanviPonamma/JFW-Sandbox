...
// Date : 01/10/2020
// Aim : To hold the functionalities of breadcrubms , cart button and to receive the custom event from  child components jfwPosItemMenuWithFiltersComponent and jfwPosItemMenuAddOrRemoveItemsComponent
...
// to get the brandid from the custom event detail
        ...
        this.template.querySelector('c-jfw-pos-item-menu-add-or-remove-items-component').doInit();
    }
    ...
    viewItemEvent(event){
        ...
        //  console.log('viewType in parent----->',this.isListView);
         this.template.querySelector('c-jfw-pos-item-menu-add-or-remove-items-component').doInit();
    }
