...
import getAccount_Apex from '@salesforce/apex/WilsonInventoryPOSCatalog_Apex.getAccount';
//pub sub model
import pubsub from 'c/pubsub';

export default class WilsonSalesManagerContentComponent extends LightningElement {
  // to track the URL
  @track urlPath;
