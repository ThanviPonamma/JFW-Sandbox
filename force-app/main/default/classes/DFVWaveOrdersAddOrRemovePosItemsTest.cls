...
private class DFVWaveOrdersAddOrRemovePosItemsTest
{
    @isTest
    private static void testController ()
    {
       ...
       Test.startTest();       
       DFVWaveOrdersAddOrRemovePosItems_Apex.getAccount();
       DFVWaveOrdersAddOrRemovePosItems_Apex.addItemToWithheldItems(program.Id, posItem1.Id);
       DFVWaveOrdersAddOrRemovePosItems_Apex.removeItemFromWithheldItems(program.Id, posItem.Id);
       Test.stopTest();  
    }
