declare module "@salesforce/apex/CopperHandleASNPosItemList_Apex.loadPosItemList" {
  export default function loadPosItemList(param: {selectedASNId: any}): Promise<any>;
}
declare module "@salesforce/apex/CopperHandleASNPosItemList_Apex.saveAdvanceShipmentNotice" {
