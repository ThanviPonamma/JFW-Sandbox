declare module "@salesforce/apex/WilsonInventoryShoppingCart_Apex.getUserDetails" {
  export default function getUserDetails(): Promise<any>;
}
declare module "@salesforce/apex/WilsonInventoryShoppingCart_Apex.getAccount" {
  export default function getAccount(): Promise<any>;
}
declare module "@salesforce/apex/WilsonInventoryShoppingCart_Apex.getCartItemsList" {
  export default function getCartItemsList(): Promise<any>;
}
declare module "@salesforce/apex/WilsonInventoryShoppingCart_Apex.getSelectedUserAddressBookListForAllItems" {
  export default function getSelectedUserAddressBookListForAllItems(param: {posItemsListWithCart: any}): Promise<any>;
}
declare module "@salesforce/apex/WilsonInventoryShoppingCart_Apex.getSelectedAddressesForPosItem" {
  export default function getSelectedAddressesForPosItem(param: {selectedPosItemDetails: any}): Promise<any>;
}
declare module "@salesforce/apex/WilsonInventoryShoppingCart_Apex.getUserAddressBookList" {
...
declare module "@salesforce/apex/WilsonInventoryShoppingCart_Apex.getPosItemUserAddressBookList" {
...
declare module "@salesforce/apex/WilsonInventoryShoppingCart_Apex.getShippingMethodList" {
  export default function getShippingMethodList(): Promise<any>;
}
declare module "@salesforce/apex/WilsonInventoryShoppingCart_Apex.saveAddressForAllOrderedItems" {
...
declare module "@salesforce/apex/WilsonInventoryShoppingCart_Apex.saveAddressForSelectedItem" {
  export default function saveAddressForSelectedItem(param: {cartItemsJSONString: any, selectedAddresses: any}): Promise<any>;
}
declare module "@salesforce/apex/WilsonInventoryShoppingCart_Apex.updateQuantityForSelectedItem" {
...
declare module "@salesforce/apex/WilsonInventoryShoppingCart_Apex.deleteCartItemFromShippingCart" {
