declare module "@salesforce/apex/InfiniumHanadleASNPOSItemsList_Apex.loadPosItemList" {
  export default function loadPosItemList(param: {selectedASNId: any}): Promise<any>;
}
declare module "@salesforce/apex/InfiniumHanadleASNPOSItemsList_Apex.saveAdvanceShipmentNotice" {
